...
class AppTheme {
  ...
  static InputDecorationTheme getStokBoxDecorationTheme() {
    return InputDecorationTheme(
        hintStyle: TextStyle(
            color: Color(0xFFA3A3A3),
            fontFamily: 'OpenSans',
  ...
  static ButtonStyle ButtonSubmit() {
    return ElevatedButton.styleFrom(
      onPrimary: Colors.white,
      primary: Color(0xFF1D5D9B),
  ...
  static ButtonStyle ButtonHalfSubmit() {
    return ElevatedButton.styleFrom(
      onPrimary: Colors.white,
      primary: Color(0xFF1D5D9B),
  ...
  static ButtonStyle ButtonHalfDownload() {
    return ElevatedButton.styleFrom(
      onPrimary: Colors.white,
      primary: Color(0xFFe7b10a),
      minimumSize: Size(150, 50),
      padding: EdgeInsets.only(left: 37, right: 37),
      shape: const RoundedRectangleBorder(
        borderRadius: BorderRadius.all(Radius.circular(7)),
  ...
  static ButtonStyle ButtonDownload() {
    return ElevatedButton.styleFrom(
      onPrimary: Colors.white,
      primary: Color(0xFF1D9B6B),
      minimumSize: Size(330, 50),
      padding: EdgeInsets.only(left: 37, right: 37),
      shape: const RoundedRectangleBorder(
        borderRadius: BorderRadius.all(Radius.circular(7)),
  ...
  static ButtonStyle ButtonCartSubmit() {
    return ElevatedButton.styleFrom(
      onPrimary: Colors.white,
      primary: Color(0xFFe7b10a),
  ...
  static ButtonStyle ButtonMin() {
    return ElevatedButton.styleFrom(
      onPrimary: Colors.white,
      primary: Color(0xFF9B1D1D),
      minimumSize: Size(30, 30),
      padding: EdgeInsets.only(left: 10, right: 10),
      shape: const RoundedRectangleBorder(
        borderRadius: BorderRadius.all(Radius.circular(50)),
